...
export const AFTER_TURN_CHECKS: AfterTurnCheck[] = [
  {
    ...
    message: [
      ...
      "",
      "Settle it. `bash` has python3 and a shell — run the smallest thing that decides the question,",
      "not the whole job. If you think a number is too large to compute, compute it and see; if you",
      "think a file cannot be parsed, parse it. If it fails, say what you ran and what it said —",
      "that is a finding and it is worth something.",
      "",
      "What you wrote instead was a prediction about feasibility presented as a result, and nobody",
