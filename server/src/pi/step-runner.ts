...
export function fixBrief(ctx: { goal: string; tasks: TaskRow[]; file?: string | null; problems: string[] }): string {
  ...
  return [
    ...
    "",
    "Fix exactly these, and nothing else. You are not redoing the work — you are correcting what",
    "the check found, and then confirming that particular thing is right.",
    "",
